...
export default function Navbar({ authenticated, setAuthenticated }) {
  ...
  async function handleRegister(e) {
    ...
    try {
      const response = await axios.post('https://nomadia.onrender.com/api/register', userData);

      setEmail("");
      setPassword("");
      setConfirmPassword("");
      setAuthenticated(true); // Assuming your authentication flow is successful
    } catch (error) {
  ...
  async function handleLogin(e) {
    ...
    // https://nomadia.onrender.com/api/
    try {
      const response = await axios.post('https://nomadia.onrender.com/api/login', userData);
      setEmail("");
      setPassword("");
      setAuthenticated(true); // Assuming your authentication flow is successful
    } catch (error) {
              ...
              <div>
                <form onSubmit={handleRegister}>
                  ...
                  <Button
                    ...
                    disabled={email === "" || password === "" || confirmPassword === "" || confirmPassword !== password ? true : false}
