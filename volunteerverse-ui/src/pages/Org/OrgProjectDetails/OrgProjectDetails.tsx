    ...
    return (
        ...
        <Tabs p={"lg"} variant="default" radius="md" defaultValue="volunteers">
          <Tabs.List position="center" >
            <Tabs.Tab value="project" icon={<IconCartCheck size={isMobile ? "1rem" : "2rem"} />}><Title weight={500} order={isMobile ? 5 : 3}>Project Details</Title></Tabs.Tab>
          ...
          <Tabs.Panel pt={"xs"} value="project">
            {/* <VolunteerProjectDetails isAuth={false} user={undefined} /> */}
          </Tabs.Panel>
